...
namespace westcoast_cars.api.Controllers
{
    ...
    public class VehiclesController : ControllerBase
    {
        ...
        public async Task<IActionResult> Add(VehiclePostViewModel vehicle)
        {
            ...
            // Hämta växellåda
            var transmission = await _context.TrasmissionsTypes.SingleOrDefaultAsync(c => c.Name.ToUpper() == vehicle.Transmission.ToUpper());
        ...
        public async Task<IActionResult> UpdateVehicle(int id, VehicleUpdateViewModel model)
        {
            ...
            // Hämta växellåda
            var transmission = await _context.TrasmissionsTypes.SingleOrDefaultAsync(c => c.Name.ToUpper() == model.Transmission.ToUpper());
            // Kontrollera att vi har den växellådan
